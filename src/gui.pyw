...
class Application(object):
    ...
    def __init__(self):
        ...
        y = (screen_h - self.HEIGHT) / 2 - screen_h / 4
        ...
        self.root.bind('<MouseWheel>',
                       lambda e: self.lstDeltas.yview(tk.SCROLL,
                                                      -1 if e.delta > 0 else 1,                                                      tk.UNITS))
        ...
        self.btnAddDelta.grid(column=3, row=5, sticky=tk.E)
        self.btnRemDelta.grid(column=4, row=5, sticky=tk.E)
        ...
        self.lstDeltas.grid(column=1, row=6, sticky=tk.NSEW, columnspan=4, rowspan=4)
